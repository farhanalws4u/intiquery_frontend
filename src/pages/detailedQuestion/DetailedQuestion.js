...
import { submitAnswer } from "../../store/actions/questionActions";
import "./styles.css";
...
function DetailedQuestion() {
  ...
  const handleAnswerSubmit = (e) => {
    ...
    setAnswer("");
    dispatch(submitAnswer({ answer: _answer, id, name }));
  };
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {"-answer by" + " " + checkUserForAns(ans.name)}
                    </Typography>
                  </Box>
                </Paper>
              );
